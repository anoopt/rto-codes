...
This folder is set up for Punjab RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Punjab, create JSON files following this pattern:

### File Naming
- Format: `pb-NN.json` (e.g., `pb-01.json`, `pb-02.json`)
...
1. Create a new file: `pb-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts punjab`
