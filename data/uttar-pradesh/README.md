# Uttar Pradesh RTO Data

This folder is set up for Uttar Pradesh RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Uttar Pradesh, create JSON files following this pattern:

### File Naming
- Format: `up-NN.json` (e.g., `up-01.json`, `up-02.json`)
...
1. Create a new file: `up-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts uttar-pradesh`
