...
This folder is set up for Haryana RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Haryana, create JSON files following this pattern:

### File Naming
- Format: `hr-NN.json` (e.g., `hr-01.json`, `hr-02.json`)
...
1. Create a new file: `hr-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts haryana`
