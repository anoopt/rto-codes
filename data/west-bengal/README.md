...
This folder is set up for West Bengal RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for West Bengal, create JSON files following this pattern:

### File Naming
- Format: `wb-NN.json` (e.g., `wb-01.json`, `wb-02.json`)
...
1. Create a new file: `wb-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts west-bengal`
