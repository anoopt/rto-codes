...
This folder is set up for Sikkim RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Sikkim, create JSON files following this pattern:

### File Naming
- Format: `sk-NN.json` (e.g., `sk-01.json`, `sk-02.json`)
...
1. Create a new file: `sk-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts sikkim`
