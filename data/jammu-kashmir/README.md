# Jammu and Kashmir RTO Data

This folder is set up for Jammu and Kashmir RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Jammu and Kashmir, create JSON files following this pattern:

### File Naming
- Format: `jk-NN.json` (e.g., `jk-01.json`, `jk-02.json`)
...
1. Create a new file: `jk-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts jammu-kashmir`
