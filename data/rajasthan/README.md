...
This folder is set up for Rajasthan RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Rajasthan, create JSON files following this pattern:

### File Naming
- Format: `rj-NN.json` (e.g., `rj-01.json`, `rj-02.json`)
...
1. Create a new file: `rj-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts rajasthan`
