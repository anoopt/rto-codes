...
This folder is set up for Kerala RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Kerala, create JSON files following this pattern:

### File Naming
- Format: `kl-NN.json` (e.g., `kl-01.json`, `kl-02.json`)
...
1. Create a new file: `kl-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts kerala`
