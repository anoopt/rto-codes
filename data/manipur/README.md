...
This folder is set up for Manipur RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Manipur, create JSON files following this pattern:

### File Naming
- Format: `mn-NN.json` (e.g., `mn-01.json`, `mn-02.json`)
...
1. Create a new file: `mn-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts manipur`
