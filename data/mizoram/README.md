...
This folder is set up for Mizoram RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Mizoram, create JSON files following this pattern:

### File Naming
- Format: `mz-NN.json` (e.g., `mz-01.json`, `mz-02.json`)
...
1. Create a new file: `mz-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts mizoram`
