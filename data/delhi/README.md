...
This folder is set up for Delhi RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Delhi, create JSON files following this pattern:

### File Naming
- Format: `dl-NN.json` (e.g., `dl-01.json`, `dl-02.json`)
...
1. Create a new file: `dl-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts delhi`
