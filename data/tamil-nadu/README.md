...
This folder is set up for Tamil Nadu RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Tamil Nadu, create JSON files following this pattern:

### File Naming
- Format: `tn-NN.json` (e.g., `tn-01.json`, `tn-02.json`)
...
1. Create a new file: `tn-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts tamil-nadu`
