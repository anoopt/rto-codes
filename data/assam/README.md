...
This folder is set up for Assam RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Assam, create JSON files following this pattern:

### File Naming
- Format: `as-NN.json` (e.g., `as-01.json`, `as-02.json`)
...
1. Create a new file: `as-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts assam`
