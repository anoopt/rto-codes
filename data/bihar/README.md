...
This folder is set up for Bihar RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Bihar, create JSON files following this pattern:

### File Naming
- Format: `br-NN.json` (e.g., `br-01.json`, `br-02.json`)
...
1. Create a new file: `br-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts bihar`
