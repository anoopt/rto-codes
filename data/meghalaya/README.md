...
This folder is set up for Meghalaya RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Meghalaya, create JSON files following this pattern:

### File Naming
- Format: `ml-NN.json` (e.g., `ml-01.json`, `ml-02.json`)
...
1. Create a new file: `ml-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts meghalaya`
