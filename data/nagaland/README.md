...
This folder is set up for Nagaland RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Nagaland, create JSON files following this pattern:

### File Naming
- Format: `nl-NN.json` (e.g., `nl-01.json`, `nl-02.json`)
...
1. Create a new file: `nl-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts nagaland`
