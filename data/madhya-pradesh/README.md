# Madhya Pradesh RTO Data

This folder is set up for Madhya Pradesh RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Madhya Pradesh, create JSON files following this pattern:

### File Naming
- Format: `mp-NN.json` (e.g., `mp-01.json`, `mp-02.json`)
...
1. Create a new file: `mp-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts madhya-pradesh`
