# Chhattisgarh RTO Data

This folder is set up for Chhattisgarh RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Chhattisgarh, create JSON files following this pattern:

### File Naming
- Format: `cg-NN.json` (e.g., `cg-01.json`, `cg-02.json`)
...
1. Create a new file: `cg-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts chhattisgarh`
