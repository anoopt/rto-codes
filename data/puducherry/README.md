...
This folder is set up for Puducherry RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Puducherry, create JSON files following this pattern:

### File Naming
- Format: `py-NN.json` (e.g., `py-01.json`, `py-02.json`)
...
1. Create a new file: `py-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts puducherry`
