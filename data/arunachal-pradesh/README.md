# Arunachal Pradesh RTO Data

This folder is set up for Arunachal Pradesh RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Arunachal Pradesh, create JSON files following this pattern:

### File Naming
- Format: `ar-NN.json` (e.g., `ar-01.json`, `ar-02.json`)
...
1. Create a new file: `ar-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts arunachal-pradesh`
