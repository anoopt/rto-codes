...
This folder is set up for Odisha RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Odisha, create JSON files following this pattern:

### File Naming
- Format: `od-NN.json` (e.g., `od-01.json`, `od-02.json`)
...
1. Create a new file: `od-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts odisha`
