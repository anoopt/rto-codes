...
This folder is set up for Gujarat RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Gujarat, create JSON files following this pattern:

### File Naming
- Format: `gj-NN.json` (e.g., `gj-01.json`, `gj-02.json`)
...
1. Create a new file: `gj-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts gujarat`
