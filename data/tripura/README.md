...
This folder is set up for Tripura RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Tripura, create JSON files following this pattern:

### File Naming
- Format: `tr-NN.json` (e.g., `tr-01.json`, `tr-02.json`)
...
1. Create a new file: `tr-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts tripura`
