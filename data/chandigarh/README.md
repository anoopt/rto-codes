...
This folder is set up for Chandigarh RTO codes but doesn't contain any RTO data yet.

## How to Contribute

To add RTO data for Chandigarh, create JSON files following this pattern:

### File Naming
- Format: `ch-NN.json` (e.g., `ch-01.json`, `ch-02.json`)
...
1. Create a new file: `ch-XX.json`
2. Add the RTO data following the structure above
3. Run validation: `bun scripts/validate-rto-data.ts chandigarh`
